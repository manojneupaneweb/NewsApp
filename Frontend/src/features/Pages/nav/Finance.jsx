    ...
    for (let page = startPage; page <= endPage; page++) {
      buttons.push(
        <button
          ...
          className={`px-3 py-2 text-sm border rounded ${currentPage === page
                ...
                {posts.map((post) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      ...
                      />
                      <span className="absolute top-3 right-3 bg-green-500 text-white text-xs font-medium px-3 py-1 rounded-full shadow-lg">
                        Finance
                      </span>
                    </div>
                    ...
                    <div className="p-4 sm:p-6">
                      ...
                      <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 line-clamp-3">
                        {post.content?.slice(0, 100) + "..." || "वित्तीय समाचारको संक्षिप्त विवरण"}
                      </p>
