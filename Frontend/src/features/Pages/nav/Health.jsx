      ...
      {loading ? (
        ...
        <section className="py-10 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-green-600 font-bold text-2xl sm:text-3xl lg:text-4xl mb-6 flex items-center gap-3">
            ...
            {posts.length > 0 ? (
                ...
                {posts.map((post) => (
                  ...
                  >
                    <div className="relative overflow-hidden">
                      ...
                      />
                      <span className="absolute top-3 right-3 bg-red-500 text-white text-xs font-medium px-3 py-1 rounded-full shadow-lg">
                        Health
                      </span>
                    </div>
                    
                    <div className="p-4 sm:p-6">
                      <h2 className="text-lg sm:text-xl font-semibold text-gray-800 hover:text-green-600 cursor-pointer line-clamp-2 mb-3">
                      ...
                      <p className="text-gray-600 text-sm sm:text-base leading-relaxed mb-4 line-clamp-3">
                        {post.content?.slice(0, 100) + "..." || post.description || "स्वास्थ्य समाचारको संक्षिप्त विवरण"}
                      </p>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-lg font-medium">
                  हाल स्वास्थ्य समाचार उपलब्ध छैन।
                </p>
              </div>
            )}
